        ...
        <div class="container">
            <div class="row align-items-center justify-content-between text-center text-lg-start">
                ...
                <div class="col-12 col-lg-auto">
                    ...
                    <span id="colorEfect" class="colorEfect amarillo"></span>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 d-flex flex-column align-items-start align-items-lg-end gap-4 mb-4 mb-lg-0">
                <button class="btnMouse w-100 w-lg-auto">Materiales</button>
                <button class="btnMouse w-100 w-lg-auto">Mano de obra</button>
                <button class="btnMouse w-100 w-lg-auto">Cronograma</button>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function actualizarUI() {
                if (estado) {
                    ...
                    btnColor.classList.remove("btn-warning");
                    ...
                    btnColor.classList.add("btn-warning");
